...
Training and evaluation: 1$\times$ NVIDIA A100-SXM4-80GB GPU on commodity
cloud infrastructure. Total wallclock for the three arms (50 steps each
...
configuration differences between our adapter and Open-RS's parser config (boxed-match
priority), or vLLM tokenizer edge cases. We report numbers vs our own base rather
than vs Open-RS reported.
