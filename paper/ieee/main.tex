...
seeds. A single-seed constant-bias ablation \armD{} tests whether the
...
transfer at this scale. The \armD{} ablation partially but not fully
reproduces \armC{}'s effect on AIME-2024 maj@8, refuting a pure
...
$+7.5$\,pp on AMC-23 over its untrained base, and an
